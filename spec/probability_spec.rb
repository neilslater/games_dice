  ...
  describe "class methods" do
    describe "#new" do
      ...
      it "should raise an error if passed incorrect parameter types" do
        expect(lambda { GamesDice::Probabilities.new( [ nil ], 20 ) }).to raise_error TypeError
        expect(lambda { GamesDice::Probabilities.new( [0.3,nil,0.5], 7 ) }).to raise_error TypeError
        expect(lambda { GamesDice::Probabilities.new( [0.3,0.2,0.5], {} ) }).to raise_error TypeError
        expect(lambda { GamesDice::Probabilities.new( {:x=>:y}, 17 ) }).to raise_error TypeError
      end

      it "should raise an error if distribution is incomplete or inaccurate" do
        expect(lambda { GamesDice::Probabilities.new( [0.3,0.2,0.6], 3 ) }).to raise_error ArgumentError
        expect(lambda { GamesDice::Probabilities.new( [], 1 ) }).to raise_error ArgumentError
        expect(lambda { GamesDice::Probabilities.new( [0.9], 1 ) }).to raise_error ArgumentError
        expect(lambda { GamesDice::Probabilities.new( [-0.9,0.2,0.9], 1 ) }).to raise_error ArgumentError
      end
    end
    ...
    describe "#for_fair_die" do
      it "should create a new distribution based on number of sides" do
        ...
        (1..20).each do |sides|
          ...
          h.values.each { |v| expect(v).to be_within(1e-10).of 1.0/sides }
        end
      end

      it "should raise an error if number of sides is not an integer" do
        expect(lambda { GamesDice::Probabilities.for_fair_die( {} ) }).to raise_error TypeError
      end

      it "should raise an error if number of sides is too low or too high" do
        expect(lambda { GamesDice::Probabilities.for_fair_die( 0 ) }).to raise_error ArgumentError
        expect(lambda { GamesDice::Probabilities.for_fair_die( 1000001 ) }).to raise_error ArgumentError
      end
    end
    ...
    describe "#add_distributions" do
      ...
      it "should raise an error if either parameter is not a GamesDice::Probabilities object" do
        ...
        expect(lambda { GamesDice::Probabilities.add_distributions( '', 6 ) }).to raise_error TypeError
        expect(lambda { GamesDice::Probabilities.add_distributions( d10, 6 ) }).to raise_error TypeError
        expect(lambda { GamesDice::Probabilities.add_distributions( '', d10 ) }).to raise_error TypeError
      end
    end
    ...
    describe "#add_distributions_mult" do
      ...
      it "should raise an error if passed incorrect objects for distributions" do
        d10 = GamesDice::Probabilities.for_fair_die( 10 )
        expect(lambda { GamesDice::Probabilities.add_distributions_mult( 1, '', -1,  6 ) }).to raise_error TypeError
        expect(lambda { GamesDice::Probabilities.add_distributions_mult( 2, d10, 3, 6 ) }).to raise_error TypeError
        expect(lambda { GamesDice::Probabilities.add_distributions_mult( 1, '', -1, d10 ) }).to raise_error TypeError
      end

      it "should raise an error if passed incorrect objects for multipliers" do
        d10 = GamesDice::Probabilities.for_fair_die( 10 )
        expect(lambda { GamesDice::Probabilities.add_distributions_mult( {}, d10, [],  d10 ) }).to raise_error TypeError
        expect(lambda { GamesDice::Probabilities.add_distributions_mult( [7], d10, 3, d10 ) }).to raise_error TypeError
        expect(lambda { GamesDice::Probabilities.add_distributions_mult( 1, d10, {}, d10 ) }).to raise_error TypeError
      end
    end
    ...
    describe "#from_h" do
      ...
      it "should raise an ArgumentError when called with a non-valid hash" do
        expect(lambda { GamesDice::Probabilities.from_h( { 7 => 0.5, 9 => 0.6 } ) }).to raise_error ArgumentError
      end

      it "should raise an TypeError when called with data that is not a hash" do
        expect(lambda { GamesDice::Probabilities.from_h( :foo ) }).to raise_error TypeError
      end

      it "should raise a TypeError when called when keys and values are not all integers and floats" do
        expect(lambda { GamesDice::Probabilities.from_h( { 'x' => 0.5, 9 => 0.5 } ) }).to raise_error TypeError
        expect(lambda { GamesDice::Probabilities.from_h( { 7 => [], 9 => 0.5 } ) }).to raise_error TypeError
      end

      it "should raise an ArgumentError when results are spread very far apart" do
        expect(lambda { GamesDice::Probabilities.from_h( { 0 => 0.5, 2000000 => 0.5 } ) }).to raise_error ArgumentError
      end
    end
    ...
    describe "#implemented_in" do
      it "should be either :c or :ruby" do
        ...
        expect([:c, :ruby].member?( lang )).to eql true
      end
    end
  ...
  describe "instance methods" do
    ...
    describe "#p_eql" do
      ...
      it "should raise a TypeError if asked for probability of non-Integer" do
        expect(lambda { pr2.p_eql( [] ) }).to raise_error TypeError
      end
    end # describe "#p_eql"
    ...
    describe "#p_gt" do
      ...
      it "should raise a TypeError if asked for probability of non-Integer" do
        expect(lambda { pr2.p_gt( {} ) }).to raise_error TypeError
      end
    end # describe "#p_gt"
    ...
    describe "#p_ge" do
      ...
      it "should raise a TypeError if asked for probability of non-Integer" do
        expect(lambda { pr4.p_ge( {} ) }).to raise_error TypeError
      end
    end # describe "#p_ge"
    ...
    describe "#p_le" do
      ...
      it "should raise a TypeError if asked for probability of non-Integer" do
        expect(lambda { pr4.p_le( [] ) }).to raise_error TypeError
      end
    end # describe "#p_le"
    ...
    describe "#p_lt" do
      ...
      it "should raise a TypeError if asked for probability of non-Integer" do
        expect(lambda { pr6.p_lt( {} ) }).to raise_error TypeError
      end
    end # describe "#p_lt"
    ...
    describe "#given_ge" do
      ...
      it "should raise a TypeError if asked for probability of non-Integer" do
        expect(lambda { pr10.given_ge( [] ) }).to raise_error TypeError
      end
    end
    ...
    describe "#given_le" do
      ...
      it "should raise a TypeError if asked for probability of non-Integer" do
        expect(lambda { pr10.given_le( {} ) }).to raise_error TypeError
      end
    end
    ...
    describe "#repeat_sum" do
      ...
      it "should raise an error if any param is unexpected type" do
        d6 = GamesDice::Probabilities.for_fair_die( 6 )
        expect(lambda{ d6.repeat_sum( {} ) }).to raise_error TypeError
      end
      ...
      it "should raise an error if distribution would have more than a million results" do
        ...
        expect(lambda{ d1000.repeat_sum( 11000 ) }).to raise_error(RuntimeError, /Too many probability slots/)
      end
    ...
    describe "#repeat_n_sum_k" do
      ...
      it "should raise an error if any param is unexpected type" do
        d6 = GamesDice::Probabilities.for_fair_die( 6 )
        expect(lambda{ d6.repeat_n_sum_k( {}, 10 ) }).to raise_error TypeError
        expect(lambda{ d6.repeat_n_sum_k( 10, {} ) }).to raise_error TypeError
      end

      it "should raise an error if n is greater than 170" do
        d6 = GamesDice::Probabilities.for_fair_die( 6 )
        expect(lambda{ d6.repeat_n_sum_k( 171, 10 ) }).to raise_error(RuntimeError, /Too many dice/)
      end
