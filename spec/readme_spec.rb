...
describe 'String Dice Description' do
  ...
  describe "'1d6'" do
    it "returns expected results from rolling" do
      ...
      expect((1..20).map { |n| d.roll }).to eql [6, 3, 2, 3, 4, 6, 4, 2, 6, 3, 3, 5, 6, 6, 3, 6, 5, 2, 1, 4]
    end
  end
  ...
  describe "'2d6 + 1d4'" do
    it "returns expected results from rolling" do
      ...
      expect((1..5).map { |n| d.roll }).to eql [11, 10, 12, 12, 14]
    end
  end
  ...
  describe "'1d100 + 1d20 - 5'" do
    it "returns expected results from rolling" do
      ...
      expect((1..5).map { |n| d.roll }).to eql [75, 78, 24, 102, 32]
    end
  end
  ...
  describe "'1d10x'" do
    it "returns expected results from rolling" do
      ...
      expect((1..20).map { |n| d.roll }).to eql [2, 3, 4, 7, 6, 7, 4, 2, 6, 3, 7, 5, 6, 7, 6, 6, 5, 19, 4, 19]
    end
  end
  ...
  describe "'1d6r1'" do
    it "returns expected results from rolling" do
      ...
      expect((1..20).map { |n| d.roll }).to eql [6, 3, 2, 3, 4, 6, 4, 2, 6, 3, 3, 5, 6, 6, 3, 6, 5, 2, 4, 2]
    end
  end
  ...
  describe "'5d10r:10,add.k2'" do
    it "returns expected results from rolling" do
      ...
      expect((1..5).map { |n| d.roll }).to eql [13, 13, 14, 38, 15]
    end
  end
  ...
  describe "'3d10m6'" do
    it "returns expected results from rolling" do
      ...
      expect((1..6).map { |n| d.roll }).to eql [0, 3, 1, 1, 3, 2]
    end
  end
  ...
  describe "'5d10k2'" do
    it "returns expected results from rolling" do
      ...
      expect((1..5).map { |n| d.roll }).to eql [13, 13, 14, 19, 19]
    end
  end
  ...
  describe "'1d10r:10,replace,1.'" do
    it "should roll a 10-sided die, re-roll a result of 10 and take the value of the second roll" do
      ...
      expect((1..27).map { d.roll }).to eql [2, 3, 4, 7, 6, 7, 4, 2, 6, 3, 7, 5, 6, 7, 6, 6, 5, 9, 4, 9, 8, 3, 1, 6, 7, 1, 1]
    end
  end
  ...
  describe "'1d20r:<=10,use_best,1.'" do
    it "should roll a 20-sided die, re-roll a result if 10 or lower, and use best result" do
      ...
      expect((1..20).map { d.roll }).to eql [ 18, 19, 20, 20, 3, 11, 7, 20, 15, 19, 6, 16, 17, 16, 15, 11, 9, 15, 20, 16 ]
    end
  end
  ...
  describe "'5d10r:>8,add.'" do
    it "returns expected results from rolling" do
      ...
      expect((1..5).map { |n| d.roll }).to eql [22, 22, 31, 64, 26]
    end
  end
  ...
  describe "'9d6x.m:10.'" do
    it "returns expected results from rolling" do
      ...
      expect((1..5).map { |n| d.roll }).to eql [1, 2, 1, 1, 1]
    end
    it "can be explained as number of exploding dice scoring 10+" do
      d = GamesDice.create '9d6x.m:10.'
      expect((1..5).map { |n| d.roll; d.explain_result }).to eql [
  ...
  describe "'5d10m:>=6,1,S.m:==1,-1,F.'" do
    it "returns expected results from rolling" do
      ...
      expect((1..10).map { |n| d.roll }).to eql [2, 2, 4, 3, 2, 1, 1, 3, 3, 0]
    end
  ...
  describe "'4d6k:3.r:1,replace,1.'" do
    it "represents roll 4 six-sided dice, re-roll any 1s, and keep best 3." do
      ...
      expect((1..10).map { |n| d.roll }).to eql [12, 14, 14, 18, 11, 17, 11, 15, 14, 14]
    end
  ...
  describe "'2d20k:1,worst.'" do
    it "represents roll 2 twenty-sided dice, return lowest of the two results" do
      ...
      expect((1..10).map { |n| d.roll }).to eql [18, 6, 2, 3, 5, 10, 15, 1, 7, 10]
    end
