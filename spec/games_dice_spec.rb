...
describe GamesDice, :aggregate_failures do
  describe '#create' do
  ...
  describe 'String Dice Description' do
    ...
    describe "'2d6 + 1d4'" do
      it 'returns expected results from rolling' do
        d = described_class.create '2d6 + 1d4'
    ...
    describe "'1d100 + 1d20 - 5'" do
      it 'returns expected results from rolling' do
        d = described_class.create '1d100 + 1d20 - 5'
    ...
    describe "'1d10x'" do
      it 'returns expected results from rolling' do
        d = described_class.create '1d10x'
    ...
    describe "'1d6r1'" do
      it 'returns expected results from rolling' do
        d = described_class.create '1d6r1'
    ...
    describe "'5d10r:10,add.k2'" do
      it 'returns expected results from rolling' do
        d = described_class.create '5d10r:10,add.k2'
    ...
    describe "'3d10m6'" do
      it 'returns expected results from rolling' do
        d = described_class.create '3d10m6'
    ...
    describe "'5d10k2'" do
      it 'returns expected results from rolling' do
        d = described_class.create '5d10k2'
    ...
    describe "'5d10x'" do
      it "is the same as '5d10r:10,add.'" do
        results1 = seeded_rolls(described_class, '5d10x', seed: 235_241, count: 50)
        results2 = seeded_rolls(described_class, '5d10r:10,add.', seed: 235_241, count: 50)
    ...
    describe "'1d6r:1.'" do
      it "return same as '1d6r1'" do
        results1 = seeded_rolls(described_class, '1d6r:1.', seed: 235_241, count: 50)
        results2 = seeded_rolls(described_class, '1d6r1', seed: 235_241, count: 50)
        expect(results1).to eql results2
      end
    end
    ...
    describe "'1d10r:10,replace,1.'" do
      it 'roll a 10-sided die, re-roll a result of 10 and take the value of the second roll' do
        d = described_class.create '1d10r:10,replace,1.'
        expect((1..27).map do
                 d.roll
    ...
    describe "'1d20r:<=10,use_best,1.'" do
      it 'roll a 20-sided die, re-roll a result if 10 or lower, and use best result' do
        d = described_class.create '1d20r:<=10,use_best,1.'
        expect((1..20).map do
                 d.roll
    ...
    describe "'5d10r:10,add.k2', '5d10xk2' and '5d10x.k2'" do
      it 'all be equivalent' do
        results1 = seeded_rolls(described_class, '5d10r:10,add.k2', seed: 135_241, count: 50)
        results2 = seeded_rolls(described_class, '5d10xk2', seed: 135_241, count: 50)
        results3 = seeded_rolls(described_class, '5d10x.k2', seed: 135_241, count: 50)
        expect(results1).to eql results2
    ...
    describe "'5d10r:>8,add.'" do
      it 'returns expected results from rolling' do
        d = described_class.create '5d10r:>8,add.'
    ...
    describe "'9d6x.m:10.'" do
      it 'returns expected results from rolling' do
        d = described_class.create '9d6x.m:10.'
    ...
    describe "'9d6x.m:10,1,S.'" do
      it 'returns expected results from rolling' do
        d = described_class.create '9d6x.m:10,1,S.'
        expect((1..5).map { |_n| d.roll }).to eql [1, 2, 1, 1, 1]
      end
    ...
    describe "'5d10m:>=6,1,S.m:==1,-1,F.'" do
      it 'returns expected results from rolling' do
        d = described_class.create '5d10m:>=6,1,S.m:==1,-1,F.'
    ...
    describe "'4d6k:3.r:1,replace,1.'" do
      it 'represents roll 4 six-sided dice, re-roll any 1s, and keep best 3.' do
        d = described_class.create '4d6k:3.r:1,replace,1.'
    ...
    describe "'2d20k:1,worst.'" do
      it 'represents roll 2 twenty-sided dice, return lowest of the two results' do
        d = described_class.create '2d20k:1,worst.'
